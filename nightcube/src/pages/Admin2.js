    ...
    <div className="bgContainer">
      <div className="overlay">
        ...
        <div className="content">
          ...
          <div class="row">
            <h1>ADMIN 2 - OUTLETS MODULE</h1>
                  <div className="transparent-table" >
                            <table className="table">
                            <thead>
                            <tr>
                                <th scope="col">MONITOR TOTAL OUTLETSS</th>
                                <th scope="col">ADD NEW OUTLETS</th>
                                <th scope="col">APPROVE ALL OUTLETS (AUTO REQUEST ON CHANGES MADE BY OUTLET - CONDITION TO T. &gt; 1)</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <th scope="row">EDIT AND UPDATE ALL OUTLETS TIME, DETAILS, OUTLETS, IMAGES, VIDEOS, CALENDAR</th>
                                <th>SOLVE AND HELP REGISTERED OUTLETS ISSUES ON REQUESTS</th>
                                <th>REPORT ALL CRASH - BUGS - ERRORS @ OUTLETS</th>
                            </tr>
                            <tr>
                                <th scope="row">DELETE OUTLETS</th>
                                <th>MAIL COMMUNICATION FOR APPROVALS & FIXING ISSUES @ OUTLET</th>
                                <th>CORROSPONDING COMMUNICATION FOR WELCOME APPROVALS @ OUTLET</th>
                            </tr>
                            </tbody>
                        </table>
                      </div>
